    ...
    return (
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pt-24 md:pt-28">
                <button
                    onClick={() => navigate(-1)}
                    className="mb-8 flex items-center text-gray-600 hover:text-gray-900 transition-colors cursor-pointer"
                >
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="flex space-x-4">    
                            <button
                                ...
                                className="bg-green-600 text-white px-6 py-3 rounded-lg font-medium hover:bg-green-700 transition-colors w-64 flex items-center justify-center space-x-2 cursor-pointer"
                            >
                ...
                <div className="bg-white rounded-lg shadow-lg p-8">
                    <div className="border-b border-gray-200 mb-8">
                        <div className="flex space-x-8">
                            <button
                                className={`pb-4 border-b-2 font-medium transition-colors cursor-pointer ${activeTab === 'description'
                            ...
                            <button
                                className={`pb-4 border-b-2 font-medium transition-colors cursor-pointer ${activeTab === 'notes'
                                    ? 'border-gray-900 text-gray-900'
                                    : 'border-transparent text-gray-500 hover:text-gray-700'
                                    }`}
                            ...
                            <button
                                className={`pb-4 border-b-2 font-medium transition-colors cursor-pointer ${activeTab === 'reviews'
                                    ? 'border-gray-900 text-gray-900'
                                    : 'border-transparent text-gray-500 hover:text-gray-700'
                                    }`}
                                    ...
                                    <form onSubmit={handleReviewSubmit} className="space-y-4">
                                        ...
                                        <div className="flex items-center gap-4">
                                            <button
                                                ...
                                                className="bg-gray-900 text-white px-6 py-2.5 rounded-lg text-sm font-medium hover:bg-gray-800 transition-colors disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
                                            >
